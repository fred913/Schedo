...
from PySide2.QtWidgets import QHBoxLayout, QSizePolicy, QSpacerItem, QVBoxLayout
from qfluentwidgets import (BodyLabel, CaptionLabel, CardWidget, ComboBox, LineEdit, ListWidget, PrimaryPushButton, PushButton, StrongBodyLabel,
                            SubtitleLabel, TitleLabel, ToolButton)


class Ui_ScheduleEdit(object):
    ...
    def setupUi(self, Form):
        ...
        self.week_type_combo.setObjectName("week_type_combo")
        ...
        self.custom_class.setObjectName("custom_class")
        ...
        self.save_schedule.setObjectName("save_schedule")
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleLabel.setText(QCoreApplication.translate("Form", "课程表编辑"))
        self.SubtitleLabel.setText(QCoreApplication.translate("Form", "课程表"))
        self.StrongBodyLabel.setText(QCoreApplication.translate("Form", "选择星期"))
        self.StrongBodyLabel_2.setText(QCoreApplication.translate("Form", "选择单/双周课表"))
        self.CaptionLabel.setText(QCoreApplication.translate("Form", "若要启用双周课表，请在“高级选项”中 启用单双周课表和设置开学日期"))
        self.copy_schedule.setText(QCoreApplication.translate("Form", "复制单周课表"))
        self.BodyLabel_2.setText(QCoreApplication.translate("Form", "课程/活动"))
        self.BodyLabel_3.setText(QCoreApplication.translate("Form", "自定义课程"))
        self.save_schedule.setText(QCoreApplication.translate("Form", "保存"))
